...
public class amigos {
    public static void main(String[] args) {
        System.out.println("dime 2 progra.boletines.boletinIDK.numeros enteros positivos y te digo si son amigos: ");
    ...
    static int amigosdea(int n1){
        int amigos=0;
        for (int i=1; i<n1; i++)//vamos viendo si cada uno de sus progra.boletines.boletinIDK.numeros menores hasta 0 son divisores
        {
    ...
    static int amigosdeb(int n2){
        int amigos=0;
        for (int i=1; i<n2; i++)//aquihacemos lo mismo, sque el codigo de mi codigo de progra.boletines.boletinIDK.numeros progra.boletines.boletinIDK.primos
        {
