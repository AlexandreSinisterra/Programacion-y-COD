 ...
 /**   // Guardar datos en archivo binario
    ...
    public static void guardarDatos(List<Double> temperaturas) {
        try {
            ...
            // Crear BufferedWriter para escritura eficiente
            BufferedWriter writer = new BufferedWriter(
                    new FileWriter("registros" + fecha + ".txt"));

            // Escribir cada temperatura en una línea del archivo
            ...
            writer.close();
            System.out.println("Datos guardados correctamente en formato texto.");
